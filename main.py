...
player_rect = pygame.Rect(WIDTH/10,HEIGHT/2 - player_size[1]/2,*player_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(bonus_size[0],WIDTH-bonus_size[0]),0-bonus_size[1], *bonus_size)
